# This is action_points.py

def generate_action_points(facebook_ids, ga4_ids, google_ads_ids, ua_tags, tiktok_ids, paused_tags, google_ads_issues, fb_events_issues):
    action_points = []
    ...
    if fb_events_issues:
        action_points.extend(fb_events_issues)
